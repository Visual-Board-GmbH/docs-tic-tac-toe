...
\begin{document}
    ...
    \\
    An dieser Stelle werden nun auch die Ziele und der Nutzen des Anwenders dargestellt.
    Meist lassen sich diese Ziele v.a. in die funktionalen Anforderungen übersetzen.
