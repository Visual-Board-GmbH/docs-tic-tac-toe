...
\begin{document}
    ...
    \begin{enumerate}
    	...
    	\item Kostenplan
    \end{enumerate}
	\includepdf[pages={1-},pagecommand={\pagestyle{fancy}}]{02_Dokumente/01_Mockups/OEG‐LWI‐SSA_Mockups_0.1_Draft.pdf}
	
	
		\includepdf[pages={1-},pagecommand={\pagestyle{fancy}},landscape=true]{02_Dokumente/02_Kostenplan/OEG‐LWI‐SSA_Kostenplan_0.1_Draft.pdf}
