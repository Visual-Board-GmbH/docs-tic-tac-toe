...
\pagestyle{fancy}
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{0.02\textwidth}|p{0.45\textwidth}|p{0.45\textwidth}}
			...
			R4 & Projektplan wurde zu sportlich geschätzt. & Meilensteine/Projektziele können nicht eignehalten werden, was zu Verschiebungen im Zeitplan führen kann. \\ \hline
