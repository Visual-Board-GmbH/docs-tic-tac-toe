...
\end{center}
    ...
    Funktionale Anforderungen sind gewünschte Funktionalitäten oder Verhaltensweisen eines Systems bzw. Produkts.
    ...
    Nicht-funktionale Anforderungen sind Anforderungen an die Qualität, in welcher die geforderte Funktionalität zu erbringen ist. Dazu zählen beispielsweise auch das Design, Konformität zu bestimmten Gesetzen/Vorschriften oder die Reaktionszeit des Systems.
